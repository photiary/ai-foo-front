        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
            ...
            <div className="h-full">
              <div className="bg-gradient-to-t from-primary/5 to-card dark:bg-card shadow-xs rounded-lg border p-6 h-full">
                <div className="space-y-3">
                  <div className="text-sm text-muted-foreground">식사의 적합성</div>
                  ...
                  <div className="space-y-3">
                    <div className={`w-full justify-center py-2 px-3 rounded-md border text-center text-sm font-medium ${
                      analysisResult.suitability.toLowerCase().includes('좋') || 
          ...
          <div className="lg:col-span-2">
            <div className="h-full">
              <div className="bg-gradient-to-t from-primary/5 to-card dark:bg-card shadow-xs rounded-lg border p-6 h-full">
                <div className="space-y-3">
                  <div className="text-sm text-muted-foreground">AI 식사 제안</div>
                  <div className="flex items-center gap-2 text-lg font-semibold">
                    <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
